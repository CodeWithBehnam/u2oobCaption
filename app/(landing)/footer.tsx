        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <span className="text-xl font-medium">u2oob.capz</span>
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} u2oob.capz, All rights reserved</span>
            </div>
        </footer>
    )
}
